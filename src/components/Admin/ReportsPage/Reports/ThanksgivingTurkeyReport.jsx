...
export default function ThanksgivingTurkeyReport(props) {
    ...
    const thanksgivingTurkeyId = "22"
    const thanksgivingTurkeyPickupId = "23"
    ...
    function RunReport() {
        ...
        Promise.all(promises).then(data => {
            ...
            const turkeyServices = svcsList.filter(svc => svc.svcTypeId == thanksgivingTurkeyId)
            const turkeyPickupServices = svcsList.filter(svc => svc.svcTypeId == thanksgivingTurkeyPickupId)

            turkeyServices.forEach(svc => {
        ...
        <TableContainer align="center"> 
            <Table className='fontFamily' size="small" align="center">
                ...
                <ReportsHeader reportDate={ reportYear }
                    ...
                    columns={["ID", "Given", "Family", "Zip", "Hholds", "Indiv", "Adults", "Children", "Seniors", "Picked Up?"]} />
            <TableBody>
            {loading ? (
                <TableRow>
